...
exports.seedQData = seedQData;
const drawpool_1 = __importDefault(require("../drawpool"));
...
async function seedQData() {
    ...
    try {
        await drawpool_1.default.query(qDetailInsertText, qDetailInsertValues);
    }
    catch (err) {
...
`
    ...
    */
    ...
    try {
        await drawpool_1.default.query(qTemplateInsertText, qTemplateInsertValues);
    }
    catch (err) {
        throw err; // will be caught by the server.ts file who calls it
    }
