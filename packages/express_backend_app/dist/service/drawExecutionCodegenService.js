...
exports.generateExecutableCodeFile = generateExecutableCodeFile;
...
function jsExecuterText(resName, testCaseNum, caseAndMethod) {
    return `
...
// `
// }
async function generateExecutableCodeFile(codeData, codeLanguage, qname, codeFolderPath, fileName, path, fs) {
    let transformedCode;
    if (codeLanguage === 'js') {
...
//# sourceMappingURL=drawExecutionCodegenService.js.map