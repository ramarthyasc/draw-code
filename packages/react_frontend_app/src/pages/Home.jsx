...
function Home() {
    ...
    if (isLoading) {
        ...
        return (
            <div className="flex flex-col justify-center items-center pb-80">
                    <div className="mt-10 mb-10">
                        <svg width="100" height="100" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11.4999 19.5004H19.4999" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M13.4999 3.50038L17.4999 7.50038" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M19.6739 5.31238C20.2026 4.7838 20.4997 4.06685 20.4998 3.31923C20.4999 2.57162 20.203 1.85459 19.6744 1.32588C19.1459 0.797172 18.4289 0.500094 17.6813 0.5C16.9337 0.499906 16.2166 0.796805 15.6879 1.32538L2.34193 14.6744C2.10975 14.9059 1.93805 15.1909 1.84193 15.5044L0.520934 19.8564C0.49509 19.9429 0.493138 20.0347 0.515286 20.1222C0.537433 20.2097 0.582855 20.2896 0.646731 20.3534C0.710607 20.4172 0.790555 20.4624 0.878093 20.4845C0.965631 20.5065 1.05749 20.5044 1.14393 20.4784L5.49693 19.1584C5.8101 19.0631 6.09511 18.8925 6.32693 18.6614L19.6739 5.31238Z" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </div>
                <div className="relative">

                    <div className="absolute left-100">
                        <svg width="250" height="250" viewBox="0 0 56 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-width="0.5" d="M30.5 13.2326C30.5 13.7067 30.1745 15.7112 29.8433 17.0214C29.6597 17.7474 29.2967 18.6894 29.0214 19.461C28.7404 20.2482 28.2545 20.9708 26.3436 22.9562C25.5491 23.7816 23.9904 24.2576 22.9137 24.9767C22.1955 25.4563 21.0282 25.7435 20.1192 26.1707C19.7099 26.434 19.3236 26.7012 18.9956 26.9128C18.8304 27.0194 18.6677 27.1244 18.5 27.2326" stroke="black" stroke-linecap="round" />
                            <path stroke-width="0.5" d="M30.8827 14.2326C30.8306 14.5349 30.725 15.141 30.5941 16.3007C30.2128 19.6803 31.0908 20.3055 31.4329 20.9389C31.8979 21.7998 33.2381 22.8817 34.1912 23.6739C34.8265 24.2019 35.4517 24.7106 36.0831 25.0167C36.6777 25.3049 37.4477 25.4215 38.1327 25.5992C38.8682 25.7253 39.6045 25.9789 39.9978 26.08C40.1831 26.1308 40.3392 26.181 40.5 26.2326" stroke="black" stroke-linecap="round" />
                            <path stroke-width="0.5" d="M15.5 32.2326C15.2736 32.4966 15.0472 33.455 14.5094 34.1502C14.0362 34.7618 13.6311 35.535 13.0906 36.2302C12.5562 36.9177 11.9289 37.5094 11.4166 38.1502C10.9315 38.757 10.2268 39.1638 9.54511 39.5382C8.8634 39.6454 8.40894 39.911 8.12638 40.151C7.95617 40.2326 7.73149 40.2326 7.5 40.2326" stroke="black" stroke-linecap="round" />
                            <path stroke-width="0.5" d="M15.2143 33.2326C14.9009 33.5895 14.6479 34.408 14.5224 35.1018C14.3774 35.9032 14.9613 36.6141 15.5578 37.1026C16.1682 37.6024 16.5319 38.2049 17.288 38.488C18.044 38.8218 18.9218 38.9249 19.8987 39.078C20.1206 39.1295 20.3074 39.1803 20.5 39.2326" stroke="black" stroke-linecap="round" />
                            <path stroke-width="0.5" d="M43.5 32.2326C43.5 32.9372 43.3969 34.5609 43.0586 35.5264C42.8266 36.1887 42.7187 36.7948 42.3562 37.4293C41.8788 38.2652 41.2125 38.6726 40.1445 39.0538C39.9078 39.1307 39.7531 39.1809 39.493 39.2067C39.2328 39.2326 38.8719 39.2326 38.5 39.2326" stroke="black" stroke-linecap="round" />
                            <path stroke-width="0.5" d="M43.5665 33.2326C43.5665 34.138 43.4638 35.9687 43.5136 37.0834C43.5554 38.0199 44.6523 38.2026 45.5336 38.911C46.127 39.388 47.0355 39.4717 47.7643 39.598C48.4327 39.7139 49.1635 39.7761 49.8122 40.0538C49.9942 40.1307 50.1995 40.1809 50.485 40.2067C50.7704 40.2326 51.1298 40.2326 51.5 40.2326" stroke="black" stroke-linecap="round" />
                            <path stroke-width="0.5" d="M0.5 36.2326C0.5 35.6687 0.604211 34.5315 0.736053 33.8087C0.955082 32.608 1.28947 31.9504 1.83974 30.8658C2.31141 29.9362 2.81158 28.6473 4.57211 26.8656C5.39518 26.0326 6.18105 25.8027 6.94447 25.5432C7.13 25.4913 7.28632 25.4402 7.67947 25.4139C8.07263 25.3875 8.69789 25.3875 9.5 25.2326" stroke="black" stroke-linecap="round" />
                            <path stroke-width="0.5" d="M3.5 23.2326C4.18943 23.4261 5.03844 23.5235 6.1819 23.789C7.19533 24.0242 7.75306 24.3962 8.2047 24.4682C8.40586 24.5003 8.49834 24.6842 8.49994 24.9504C8.50784 26.2684 7.75785 27.0115 7.43787 27.6181C6.94218 28.5577 6.21621 29.4842 6.00077 30.1148C5.9481 30.309 5.84277 30.549 5.76218 30.7446C5.68159 30.9402 5.62892 31.0842 5.57466 31.2326" stroke="black" stroke-linecap="round" />
                            <path stroke-width="0.5" d="M22.5 28.3163C22.555 28.6809 22.8867 29.7243 23.4425 30.6703C23.9032 31.4544 24.11 32.2418 24.6367 33.7056C25.0361 34.8157 25.2767 35.6455 25.3608 36.9804C25.3883 37.2719 25.4433 37.4275 25.4717 37.7928C25.5 38.1582 25.5 38.7286 25.5 39.3163" stroke="black" stroke-linecap="round" />
                            <path stroke-width="0.5" d="M21.5 35.1733C21.8122 35.1733 23.0592 36.1161 24.3196 37.7866C24.5817 38.1339 24.8412 38.3953 25.1816 38.2945C27.0792 37.7326 27.4043 35.6018 28.2161 34.5948C28.8192 33.9051 29.1329 33.3766 29.3157 32.9806C29.3949 32.7941 29.4467 32.637 29.5 32.3163" stroke="black" stroke-linecap="round" />
                            <path stroke-width="0.5" d="M27.2077 41.6837C27.7362 41.567 28.4414 41.0968 29.1201 40.449C29.7479 39.8499 29.9756 39.0359 30.505 38.328C30.9645 37.7135 30.9195 34.6983 30.7145 32.8486C30.6258 32.0484 30.0958 31.2021 29.684 30.3741C29.2962 29.5944 28.802 28.6675 28.0941 27.4594C27.5739 26.5716 26.8577 26.0728 26.3849 25.3666C25.6189 24.2227 24.3266 23.6017 23.3809 22.7736C22.6532 22.1364 22.202 21.1837 21.4959 20.5059C20.3294 19.3861 19.9042 18.5324 19.1097 17.5603C18.5274 16.8478 17.3766 15.6513 16.1959 14.2638C13.8015 11.45 13.1875 10.5219 12.5981 9.51798C12.1253 8.7128 12.1836 6.52731 12.3886 5.06909C12.5227 4.1156 13.4173 3.3917 14.1252 2.53532C14.6218 1.93459 15.5384 1.97413 18.3002 1.9432C19.4738 1.93005 20.2506 2.73771 21.1653 3.032C22.0309 3.31047 22.6085 3.79823 23.3164 4.32761C24.0827 4.62367 24.7313 4.85875 25.1131 5.03551C25.3199 5.0956 25.5532 5.0956 25.7936 5.0956" stroke="black" stroke-linecap="round" />
                            <path stroke-width="0.5" d="M25.2634 0.5C25.2634 1.60648 25.38 4.5618 25.4993 5.21137C24.62 5.44911 23.0893 5.56577 20.0606 5.65503C19.4323 5.68419 19.2573 5.74252 18.9002 5.80262" stroke="black" stroke-linecap="round" />
                            <path stroke-width="0.5" d="M30.5 5.81635C32.433 5.81635 34 7.38335 34 9.31635C34 11.2493 32.433 12.8163 30.5 12.8163C28.567 12.8163 27 11.2493 27 9.31635C27 7.38335 28.567 5.81635 30.5 5.81635Z" stroke="black" />
                            <path stroke-width="0.5" d="M51.5 39.8163C53.433 39.8163 55 41.3834 55 43.3163C55 45.2493 53.433 46.8163 51.5 46.8163C49.567 46.8163 48 45.2493 48 43.3163C48 41.3834 49.567 39.8163 51.5 39.8163Z" stroke="black" />
                            <path stroke-width="0.5" d="M37.5 39.8163C39.433 39.8163 41 41.3834 41 43.3163C41 45.2493 39.433 46.8163 37.5 46.8163C35.567 46.8163 34 45.2493 34 43.3163C34 41.3834 35.567 39.8163 37.5 39.8163Z" stroke="black" />
                            <path stroke-width="0.5" d="M5.5 39.8163C7.433 39.8163 9 41.3834 9 43.3163C9 45.2493 7.433 46.8163 5.5 46.8163C3.567 46.8163 2 45.2493 2 43.3163C2 41.3834 3.567 39.8163 5.5 39.8163Z" stroke="black" />
                            <path stroke-width="0.5" d="M21.5 39.8163C23.433 39.8163 25 41.3834 25 43.3163C25 45.2493 23.433 46.8163 21.5 46.8163C19.567 46.8163 18 45.2493 18 43.3163C18 41.3834 19.567 39.8163 21.5 39.8163Z" stroke="black" />
                            <path stroke-width="0.5" d="M43.5 25.8163C45.433 25.8163 47 27.3834 47 29.3163C47 31.2493 45.433 32.8163 43.5 32.8163C41.567 32.8163 40 31.2493 40 29.3163C40 27.3834 41.567 25.8163 43.5 25.8163Z" stroke="black" />
                            <path stroke-width="0.5" d="M15.5 25.8163C17.433 25.8163 19 27.3834 19 29.3163C19 31.2493 17.433 32.8163 15.5 32.8163C13.567 32.8163 12 31.2493 12 29.3163C12 27.3834 13.567 25.8163 15.5 25.8163Z" stroke="black" />
                        </svg>

                    </div>
                    <div className="absolute left-100 top-61">
                        <svg width="70" height="70" viewBox="0 0 39 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-width="0.5" d="M0.5 0.5C0.5 0.867539 0.5 3.17023 0.568914 6.55604C0.616288 8.8836 1.05688 10.237 1.37987 11.4698C1.90362 13.4688 2.44629 14.2771 3.02683 15.6234C3.53407 16.7997 4.39257 18.1252 5.29959 19.106C6.53785 20.445 7.96773 21.3328 8.64155 21.7992C9.53127 22.415 10.8412 22.6804 14.8466 24.3002C17.1343 25.2254 18.5456 25.2337 19.431 25.304C20.3626 25.378 21.5639 25.604 22.7702 25.7446C24.9901 25.9771 27.7842 26.069 29.5801 26.2082C31.1004 26.2556 33.857 26.2556 36.697 26.2556" stroke="black" stroke-linecap="round" />
                            <path stroke-width="0.5" d="M33.0773 22.3574C34.4681 23.4239 34.9317 23.8861 35.5575 24.4207C36.218 24.9849 37.2038 25.3729 37.6479 25.6507C38.4224 26.135 36.5606 26.857 34.8016 27.7139C33.637 28.2965 32.2504 29.0344 31.1777 29.5955C30.9904 29.6887 30.8526 29.7806 30.5714 30.0145" stroke="black" stroke-linecap="round" />
                        </svg>

                    </div>
                    <div className="absolute left-120 top-62">
                        <svg width="100" height="100" viewBox="0 0 27 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="absolute left-138 top-24">
                        <svg width="200" height="200" viewBox="0 0 94 132" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-width="0.5" d="M8.43938 130.989C8.5334 130.989 8.62742 130.989 10.9323 130.989C13.2373 130.989 17.7502 130.989 26.0454 129.438C34.3405 127.886 46.2811 124.784 53.1845 122.903C61.6325 120.602 63.8002 119.501 65.1265 118.79C66.4157 118.099 67.6949 117.507 69.3018 116.561C71.7749 115.105 75.8434 112.866 80.9575 109.034C83.7431 106.946 86.4477 103.979 88.0888 101.727C90.6487 98.214 91.0576 95.1016 91.9123 92.875C92.6836 90.8657 92.3909 88.7367 92.6758 84.3975C92.8986 81.0045 92.7727 75.1693 91.9265 70.2389C91.0804 65.3086 89.388 61.4538 88.1401 58.9978C86.3547 55.4841 84.7069 53.1287 82.1114 48.875C80.3595 46.0039 76.9773 42.1767 73.2151 38.6382C69.4528 35.0996 65.2219 32.0909 62.1962 30.1649C57.6195 27.2517 53.948 25.4896 50.3952 23.2616C47.1082 21.2003 43.5004 19.6005 38.8678 16.9038C35.9877 15.2273 31.7906 13.361 29.1424 12.2028C23.7459 9.84277 20.6107 8.76821 17.8514 7.43768C15.2829 6.67412 13.0093 6.10715 6.80258 4.96751C5.31392 4.77377 4.46774 4.77377 3.311 4.48886" stroke="black" stroke-linecap="round" />
                            <path stroke-width="0.5" d="M6.72993 0.500126C5.8809 0.876207 3.60731 2.20389 2.08162 3.06147C1.71064 3.26999 1.23117 3.4404 0.894971 3.6783C0.558778 3.9162 0.370737 4.19826 0.602939 4.90768C1.49328 6.74535 2.35941 8.18984 2.69133 8.80525C2.83521 9.13859 2.92923 9.51468 3.59592 10.472" stroke="black" stroke-linecap="round" />
                        </svg>

                    </div>
                    <div className="absolute left-120 top-85">
                        <svg width="100" height="100" viewBox="0 0 18 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-width="0.5" d="M9.90482 0.5V64.5251" stroke="black" stroke-linecap="round" />
                            <path stroke-width="0.5" d="M0.500002 61.993C5.79564 67.6504 8.68943 70.3054 9.9012 70.8589C11.3445 65.7477 13.9923 60.5642 15.98 57.5529C16.7739 56.3321 17.1321 55.7352 17.501 55.1203" stroke="black" stroke-linecap="round" />
                        </svg>

                    </div>
                    <div className="absolute left-120 top-105">
                        <svg width="100" height="100" viewBox="0 0 42 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="absolute left-133 -top-45">
                    ...
                    <div className="absolute left-133 top-120">
                ...
                {/* // TABLE */}
                <div className="h-80 w-100 overflow-clip ">
